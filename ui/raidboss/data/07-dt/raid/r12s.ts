  ...
  config: [
    ...
    },
    {
      ...
      options: {
        ...
        ko: {
          'DN: 어둠 - 북 히트박스, 바람 - 중앙 히트박스, 땅/불 - 남북 칼끝딜': 'dn',
    ...
    },
    {
      ...
      outputStrings: {
        ...
        innerBlobTower: {
          ...
          ko: '살점 탑 ${num} 안 ${dir} (나중에)',
        },
        outerBlobTower: {
          en: 'Blob Tower ${num} Outer ${dir} (later)',
          ko: '살점 탑 ${num} 바깥 ${dir} (나중에)',
        },
      },
    },
    {
    ...
    },
    {
      ...
      outputStrings: {
        ...
        alpha1: {
          ...
          ko: '${chains} 1 (${exit}) + 살점 탑 3 (바깥)',
        },
        alpha1Dir: {
          en: '${chains} 1 (${exit}) + Blob Tower 3 (Outer ${dir})',
          ko: '${chains} 1 (${exit}) + 살점 탑 3 (바깥 ${dir})',
        },
        alpha1ExitDir: {
          en: '${chains} 1 (${exit}) + Blob Tower 3 (Outer ${dir})',
          ko: '${chains} 1 (${exit}) + 살점 탑 3 (바깥 ${dir})',
        ...
        alpha2: {
          ...
          ko: '${chains} 2 (${exit}) + 살점 탑 4 (바깥)',
        },
        alpha2Dir: {
          en: '${chains} 2 (${exit}) + Blob Tower 4 (Outer ${dir})',
          ko: '${chains} 2 (${exit}) + 살점 탑 4 (바깥 ${dir})',
        },
        alpha3: {
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Mutating Cells': '변이세포',
        'Netherworld Far': '지하세계: 원거리',
        'Netherworld Near': '지하세계: 근거리',
        'Netherwrath Far': '지하의 분노: 원거리',
        'Netherwrath Near': '지하의 분노: 근거리',
        'Northeast': '북동쪽',
        'Northwest': '북서쪽',
